...
This was my experimentation of swapping icons. I hadn't yet tested it with my icons because I wanted to make sure that it worked before testing with my own. I only included the most important lines of code to highlight my experimentation with swapping out icons.
...
Architecture - It turned out too detail, as I suspected, so for the next iteration I'm going to limit the amount of bricks and then if I still don't like that, I'm going to completely get rid of it.
...
Looking back, I'm noticing that the blue background are actually all slightly different so there is slightly less cohesion compared to the last.
...
I either took apart the icons, or I just used the icons as is and placed it on the new base of the flipped sets. The colours were quite simple to choose, I tried not to repeat too many colours and I just used whatever suited the original icons. 
